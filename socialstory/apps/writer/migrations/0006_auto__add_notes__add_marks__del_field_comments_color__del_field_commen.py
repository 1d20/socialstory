...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Notes'
        db.create_table('writer_notes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_notes', to=orm['auth.User'])),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(related_name='branch_notes', to=orm['stories.Branch'])),
        ...
        db.send_create_signal('writer', ['Notes'])

        # Adding model 'Marks'
        db.create_table('writer_marks', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_marks', to=orm['auth.User'])),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(related_name='branch_marks', to=orm['stories.Branch'])),
            ('paragraph_index', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10)),
            ('date_add', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('writer', ['Marks'])

        # Deleting field 'Comments.color'
        db.delete_column('writer_comments', 'color')

        # Deleting field 'Comments.story'
        db.delete_column('writer_comments', 'story_id')

        # Deleting field 'Comments.length'
        db.delete_column('writer_comments', 'length')

        # Adding field 'Comments.branch'
        db.add_column('writer_comments', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='branch_comment', to=orm['stories.Branch']),
                      keep_default=False)

        # Adding field 'Comments.last_char'
        db.add_column('writer_comments', 'last_char',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('writer_notes')

        # Deleting model 'Marks'
        db.delete_table('writer_marks')

        # Adding field 'Comments.color'
        db.add_column('writer_comments', 'color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15),
                      keep_default=False)

        # Adding field 'Comments.story'
        db.add_column('writer_comments', 'story',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='story_comment', to=orm['stories.Story']),
                      keep_default=False)
        ...
        # Deleting field 'Comments.branch'
        db.delete_column('writer_comments', 'branch_id')

        # Deleting field 'Comments.last_char'
        db.delete_column('writer_comments', 'last_char')
