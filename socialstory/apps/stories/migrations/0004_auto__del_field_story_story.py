...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('stories_story', 'story')


    def backwards(self, orm):
        # Adding field 'Story.story'
        db.add_column('stories_story', 'story',
                      self.gf('django.db.models.fields.files.FileField')(default='stories/default.txt', max_length=100),
                      keep_default=False)
