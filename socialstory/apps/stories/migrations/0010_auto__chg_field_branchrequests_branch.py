...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BranchRequests.branch'
        db.alter_column('stories_branchrequests', 'branch_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stories.Branch']))

    def backwards(self, orm):

        # Changing field 'BranchRequests.branch'
        db.alter_column('stories_branchrequests', 'branch_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stories.Story']))
    ...
    models = {
        ...
        'stories.branchrequests': {
            ...
            'branch': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'branchrequest_branch'", 'to': "orm['stories.Branch']"}),
