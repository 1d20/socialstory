...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feedback_feedbackmessage', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedback_user', to=orm['auth.User'])),
    ...
    models = {
        ...
        'feedback.feedbackmessage': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'feedback_user'", 'to': "orm['auth.User']"})
        }
    }
